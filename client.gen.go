...
type ServerInterface interface {
	...
	GetApiConfigDefault(ctx echo.Context) error
	// 获取全局设置
	// (GET /api/config/global)
	GetApiConfigGlobal(ctx echo.Context) error
	// 设置全局设置
	// (POST /api/config/global)
	PostApiConfigGlobal(ctx echo.Context) error
	// 获取录播目录文件信息
	// (GET /api/file)
	FileGetFiles(ctx echo.Context, params FileGetFilesParams) error
	// 获取 JSON 日志
	// (GET /api/log/fetch)
	GetApiLogFetch(ctx echo.Context, params GetApiLogFetchParams) error
	// 根据传入参数生成录播文件名
	// (POST /api/misc/generatefilename)
	PostApiMiscGeneratefilename(ctx echo.Context) error
	// 列出所有直播间
	// (GET /api/room)
	RoomGetRooms(ctx echo.Context) error
	// 添加直播间
	// (POST /api/room)
	RoomCreateRoom(ctx echo.Context) error
	// 删除直播间
	// (DELETE /api/room/{objectId})
	DeleteApiRoomObjectId(ctx echo.Context, objectId openapi_types.UUID) error
	// 读取一个直播间
	// (GET /api/room/{objectId})
	GetApiRoomObjectId(ctx echo.Context, objectId openapi_types.UUID) error
	// 读取直播间设置
	// (GET /api/room/{objectId}/config)
	GetApiRoomObjectIdConfig(ctx echo.Context, objectId openapi_types.UUID) error
	// 修改直播间设置
	// (POST /api/room/{objectId}/config)
	PostApiRoomObjectIdConfig(ctx echo.Context, objectId openapi_types.UUID) error
	// 读取直播间 IO 统计信息
	// (GET /api/room/{objectId}/iostats)
	GetApiRoomObjectIdIostats(ctx echo.Context, objectId openapi_types.UUID) error
	// 刷新直播间信息
	// (POST /api/room/{objectId}/refresh)
	PostApiRoomObjectIdRefresh(ctx echo.Context, objectId openapi_types.UUID) error
	// 手动分段
	// (POST /api/room/{objectId}/split)
	PostApiRoomObjectIdSplit(ctx echo.Context, objectId openapi_types.UUID) error
	// 开始录制
	// (POST /api/room/{objectId}/start)
	PostApiRoomObjectIdStart(ctx echo.Context, objectId openapi_types.UUID) error
	// 读取直播间录制统计信息
	// (GET /api/room/{objectId}/stats)
	GetApiRoomObjectIdStats(ctx echo.Context, objectId openapi_types.UUID) error
	// 停止录制
	// (POST /api/room/{objectId}/stop)
	PostApiRoomObjectIdStop(ctx echo.Context, objectId openapi_types.UUID) error
	// 删除直播间
	// (DELETE /api/room/{roomId})
	DeleteApiRoomRoomId(ctx echo.Context, roomId int32) error
	// 读取一个直播间
	// (GET /api/room/{roomId})
	GetApiRoomRoomId(ctx echo.Context, roomId int32) error
	// 读取直播间设置
	// (GET /api/room/{roomId}/config)
	GetApiRoomRoomIdConfig(ctx echo.Context, roomId int32) error
	// 修改直播间设置
	// (POST /api/room/{roomId}/config)
	PostApiRoomRoomIdConfig(ctx echo.Context, roomId int32) error
	// 读取直播间 IO 统计信息
	// (GET /api/room/{roomId}/iostats)
	GetApiRoomRoomIdIostats(ctx echo.Context, roomId int32) error
	// 刷新直播间信息
	// (POST /api/room/{roomId}/refresh)
	PostApiRoomRoomIdRefresh(ctx echo.Context, roomId int32) error
	// 手动分段
	// (POST /api/room/{roomId}/split)
	PostApiRoomRoomIdSplit(ctx echo.Context, roomId int32) error
	// 开始录制
	// (POST /api/room/{roomId}/start)
	PostApiRoomRoomIdStart(ctx echo.Context, roomId int32) error
	// 读取直播间录制统计信息
	// (GET /api/room/{roomId}/stats)
	GetApiRoomRoomIdStats(ctx echo.Context, roomId int32) error
	// 停止录制
	// (POST /api/room/{roomId}/stop)
	PostApiRoomRoomIdStop(ctx echo.Context, roomId int32) error
	// 读取软件版本信息
	// (GET /api/version)
	VersionGetVersion(ctx echo.Context) error
}
...
// GetApiConfigDefault converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiConfigDefault(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiConfigDefault(ctx)
	return err
}

// GetApiConfigGlobal converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiConfigGlobal(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiConfigGlobal(ctx)
	return err
}

// PostApiConfigGlobal converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiConfigGlobal(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiConfigGlobal(ctx)
	return err
}

// FileGetFiles converts echo context to params.
func (w *ServerInterfaceWrapper) FileGetFiles(ctx echo.Context) error {
	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params FileGetFilesParams
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.FileGetFiles(ctx, params)
	return err
}

// GetApiLogFetch converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiLogFetch(ctx echo.Context) error {
	var err error

	// Parameter object where we will unmarshal all parameters from the context
	var params GetApiLogFetchParams
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiLogFetch(ctx, params)
	return err
}

// PostApiMiscGeneratefilename converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiMiscGeneratefilename(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiMiscGeneratefilename(ctx)
	return err
}

// RoomGetRooms converts echo context to params.
func (w *ServerInterfaceWrapper) RoomGetRooms(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.RoomGetRooms(ctx)
	return err
}

// RoomCreateRoom converts echo context to params.
func (w *ServerInterfaceWrapper) RoomCreateRoom(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.RoomCreateRoom(ctx)
	return err
}

// DeleteApiRoomObjectId converts echo context to params.
func (w *ServerInterfaceWrapper) DeleteApiRoomObjectId(ctx echo.Context) error {
	var err error
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.DeleteApiRoomObjectId(ctx, objectId)
	return err
}

// GetApiRoomObjectId converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiRoomObjectId(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "objectId" -------------
	var objectId openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiRoomObjectId(ctx, objectId)
	return err
}

// GetApiRoomObjectIdConfig converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiRoomObjectIdConfig(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "objectId" -------------
	var objectId openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiRoomObjectIdConfig(ctx, objectId)
	return err
}

// PostApiRoomObjectIdConfig converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiRoomObjectIdConfig(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "objectId" -------------
	var objectId openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiRoomObjectIdConfig(ctx, objectId)
	return err
}

// GetApiRoomObjectIdIostats converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiRoomObjectIdIostats(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "objectId" -------------
	var objectId openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiRoomObjectIdIostats(ctx, objectId)
	return err
}

// PostApiRoomObjectIdRefresh converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiRoomObjectIdRefresh(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "objectId" -------------
	var objectId openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiRoomObjectIdRefresh(ctx, objectId)
	return err
}

// PostApiRoomObjectIdSplit converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiRoomObjectIdSplit(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "objectId" -------------
	var objectId openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiRoomObjectIdSplit(ctx, objectId)
	return err
}

// PostApiRoomObjectIdStart converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiRoomObjectIdStart(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "objectId" -------------
	var objectId openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiRoomObjectIdStart(ctx, objectId)
	return err
}

// GetApiRoomObjectIdStats converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiRoomObjectIdStats(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "objectId" -------------
	var objectId openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiRoomObjectIdStats(ctx, objectId)
	return err
}

// PostApiRoomObjectIdStop converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiRoomObjectIdStop(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "objectId" -------------
	var objectId openapi_types.UUID
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiRoomObjectIdStop(ctx, objectId)
	return err
}

// DeleteApiRoomRoomId converts echo context to params.
func (w *ServerInterfaceWrapper) DeleteApiRoomRoomId(ctx echo.Context) error {
	var err error
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.DeleteApiRoomRoomId(ctx, roomId)
	return err
}

// GetApiRoomRoomId converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiRoomRoomId(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "roomId" -------------
	var roomId int32
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiRoomRoomId(ctx, roomId)
	return err
}

// GetApiRoomRoomIdConfig converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiRoomRoomIdConfig(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "roomId" -------------
	var roomId int32
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiRoomRoomIdConfig(ctx, roomId)
	return err
}

// PostApiRoomRoomIdConfig converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiRoomRoomIdConfig(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "roomId" -------------
	var roomId int32
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiRoomRoomIdConfig(ctx, roomId)
	return err
}

// GetApiRoomRoomIdIostats converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiRoomRoomIdIostats(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "roomId" -------------
	var roomId int32
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiRoomRoomIdIostats(ctx, roomId)
	return err
}

// PostApiRoomRoomIdRefresh converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiRoomRoomIdRefresh(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "roomId" -------------
	var roomId int32
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiRoomRoomIdRefresh(ctx, roomId)
	return err
}

// PostApiRoomRoomIdSplit converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiRoomRoomIdSplit(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "roomId" -------------
	var roomId int32
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiRoomRoomIdSplit(ctx, roomId)
	return err
}

// PostApiRoomRoomIdStart converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiRoomRoomIdStart(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "roomId" -------------
	var roomId int32
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiRoomRoomIdStart(ctx, roomId)
	return err
}

// GetApiRoomRoomIdStats converts echo context to params.
func (w *ServerInterfaceWrapper) GetApiRoomRoomIdStats(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "roomId" -------------
	var roomId int32
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetApiRoomRoomIdStats(ctx, roomId)
	return err
}

// PostApiRoomRoomIdStop converts echo context to params.
func (w *ServerInterfaceWrapper) PostApiRoomRoomIdStop(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "roomId" -------------
	var roomId int32
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PostApiRoomRoomIdStop(ctx, roomId)
	return err
}

// VersionGetVersion converts echo context to params.
func (w *ServerInterfaceWrapper) VersionGetVersion(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.VersionGetVersion(ctx)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/api/config/default", wrapper.GetApiConfigDefault)
	router.GET(baseURL+"/api/config/global", wrapper.GetApiConfigGlobal)
	router.POST(baseURL+"/api/config/global", wrapper.PostApiConfigGlobal)
	router.GET(baseURL+"/api/file", wrapper.FileGetFiles)
	router.GET(baseURL+"/api/log/fetch", wrapper.GetApiLogFetch)
	router.POST(baseURL+"/api/misc/generatefilename", wrapper.PostApiMiscGeneratefilename)
	router.GET(baseURL+"/api/room", wrapper.RoomGetRooms)
	router.POST(baseURL+"/api/room", wrapper.RoomCreateRoom)
	router.DELETE(baseURL+"/api/room/:objectId", wrapper.DeleteApiRoomObjectId)
	router.GET(baseURL+"/api/room/:objectId", wrapper.GetApiRoomObjectId)
	router.GET(baseURL+"/api/room/:objectId/config", wrapper.GetApiRoomObjectIdConfig)
	router.POST(baseURL+"/api/room/:objectId/config", wrapper.PostApiRoomObjectIdConfig)
	router.GET(baseURL+"/api/room/:objectId/iostats", wrapper.GetApiRoomObjectIdIostats)
	router.POST(baseURL+"/api/room/:objectId/refresh", wrapper.PostApiRoomObjectIdRefresh)
	router.POST(baseURL+"/api/room/:objectId/split", wrapper.PostApiRoomObjectIdSplit)
	router.POST(baseURL+"/api/room/:objectId/start", wrapper.PostApiRoomObjectIdStart)
	router.GET(baseURL+"/api/room/:objectId/stats", wrapper.GetApiRoomObjectIdStats)
	router.POST(baseURL+"/api/room/:objectId/stop", wrapper.PostApiRoomObjectIdStop)
	router.DELETE(baseURL+"/api/room/:roomId", wrapper.DeleteApiRoomRoomId)
	router.GET(baseURL+"/api/room/:roomId", wrapper.GetApiRoomRoomId)
	router.GET(baseURL+"/api/room/:roomId/config", wrapper.GetApiRoomRoomIdConfig)
	router.POST(baseURL+"/api/room/:roomId/config", wrapper.PostApiRoomRoomIdConfig)
	router.GET(baseURL+"/api/room/:roomId/iostats", wrapper.GetApiRoomRoomIdIostats)
	router.POST(baseURL+"/api/room/:roomId/refresh", wrapper.PostApiRoomRoomIdRefresh)
	router.POST(baseURL+"/api/room/:roomId/split", wrapper.PostApiRoomRoomIdSplit)
	router.POST(baseURL+"/api/room/:roomId/start", wrapper.PostApiRoomRoomIdStart)
	router.GET(baseURL+"/api/room/:roomId/stats", wrapper.GetApiRoomRoomIdStats)
	router.POST(baseURL+"/api/room/:roomId/stop", wrapper.PostApiRoomRoomIdStop)
	router.GET(baseURL+"/api/version", wrapper.VersionGetVersion)
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+xdX3fTxrb/Kl669+H+Mbj/1n3IW/6cpDkLSI4d4IHDw8Qa21MkjTozSshlZa20C0hS",
	"COG0QApNF+XccGGdU5L0tgdSkjQf5lhy8sRXuEsa2ZFlyZJGdlOoXljB1vxm9uzf3ntm79H4mlTGqo41",
	"qDEqDVyTaLkGVeD8OagoeBbKg7JMIKWjQEXKnP051AxVGrj0Xv79/Af5U+9fzksVTFTApAEJaezDD6S8",
	"xOZ0yP8Lq5BI8/lAsAmdIawBxQYFsoz4/yYJ1iFhCFJpoAIUCvOS7vnomlQD9AJQDGj/7XY0jbECgWZ3",
	"NNP86l8JrEgD0r8UjgUsuNIVAkWbn28NHE9/AsvMhhviyP0dqv+roIEMEwgYLGKsjjCccBjAYLgIy5jI",
	"wQMhGKvjzneRmgwcmsEY0qpnsQz9/IhHDg/AyXHCK0WgmCNAU8EVY4oAjeqYsCB58x/GkzgI6+RED5Qs",
	"eA5gBRgKG8ZaBVUTDrSM8RXkjEUzFAVMK1AaYMSAeYlAIE9otnfh/3e7pYwgrWp3W+a6GZqbQkxxIEKa",
	"eCQvt7MytupbLc8Z6jQkgVYR0rtHwTKf0kGD1aDGUBkweBGxWokRCFRIziM5nhSyTzViqsxLFaTAc0CF",
	"3A1MQVVXABNTRkWZmSS4DCnFpKQriE1opTJBOpsC1XhCVZSZiwQxeBYyIAMG4rVS0Awc1NHHmDKhcWuQ",
	"zWJypTU1YfEteeDoxD5PYWmOMqhOEnx1Lp58xFGNq0CBJqOKQWvjGoNkhjsRAdq2AY6hChMYx5gBiCzQ",
	"rghmBVqVDB2S4RpINNI4TqF4/GSrHdKqfzKAgticEAMpmIHcAwzjGe5aokfMkIq06qCOppAKscEENcth",
	"hmuwfCUlRzhSU2mQkblUQM0J0TQ7xqRH6tWIHJxz+E9aKqyLgJVrMq6mU55BIeE+Voh3s3D6Y4yvnCcK",
	"Tdv+wgdiCHrlHGaoMsfntsQAiWmws3qlVMOzTuAf1ORBAmOFi6DFyyhS7ABShNRQWMLFC7yKeNgJiGZI",
	"4c8gBlXnD6zBiYo0cKm7g7GHY6/l5/MRz2FFhsR58rIdanxz7w4IEAKcUKQDVgvSkU8nYRMUZ3cBFCWm",
